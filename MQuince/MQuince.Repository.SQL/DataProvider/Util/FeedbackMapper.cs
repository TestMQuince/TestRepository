...
namespace MQuince.Repository.SQL.DataProvider.Util
{
    public class FeedbackMapper
    {
        ...
        public static FeedbackPersistence MapFeedbackEntityToFeedbackPersistence(Feedback feedback)
        {
            ...
            FeedbackPersistence retVal = new FeedbackPersistence() { Id = feedback.Id, UserId = feedback.UserId,  Comment = feedback.Comment, Anonymous = feedback.Anonymous, Publish = feedback.Publish, Approved = feedback.Approved };
            return retVal;
        }
